...
1. Workspace Cargo.toml — add chronis to members, add clap/tabled/ratatui/crossterm
2. Chronis Cargo.toml — add ratatui, crossterm, axum, tower-http
...
```bash
cargo build -p chronis
cargo test -p chronis        # existing 8 tests still pass
