...
> **AllSource** — durable, event-sourced memory for AI agents: records every event, recalls it in ~12μs, survives restarts, with provenance and time-travel. MCP-native (drops into Claude), self-host free (MIT). github.com/all-source-os/all-source
