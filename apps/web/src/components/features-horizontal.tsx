        ...
        <div className="max-w-6xl mx-auto ">
          <div className="">
            ...
            >
              ...
              >
                {data.map((item, index) => (
                  <AccordionItem key={item.id} className="relative mb-8" value={`item-${index}`}>
                    ...
                    <AccordionTrigger>
                      <div className="flex items-center relative flex-col">
                        ...
                        <div className="justify-center text-center mb-4">{item.content}</div>
                      </div>
                    </AccordionTrigger>
                  </AccordionItem>
                ))}
            ...
            <div className={`w-auto overflow-hidden relative rounded-lg ${ltr && "md:order-1"}`}>
