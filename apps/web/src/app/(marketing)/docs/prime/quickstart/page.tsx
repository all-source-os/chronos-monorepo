...
export const metadata = constructMetadata({
  ...
  description: "Install AllSource Prime and store your first agent memory.",
  ...
  return (
    <div className="mx-auto w-full max-w-screen-md px-4 lg:px-8 py-24">
      <h1 className="text-3xl font-bold text-foreground sm:text-4xl mb-2">
        Install Prime and store your first memory
      </h1>
      <p className="text-lg text-muted-foreground mb-10">
        Install Prime, connect an MCP client, and store a durable memory.
      </p>
  ...
  "mcpServers": {
    "prime": {
      ...
      "args": ["--data-dir", "~/.prime/memory"]
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Restart Claude Desktop. You now have 19 tools for knowledge management.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-foreground mb-3">3. Store your first memory</h2>
          <p className="text-muted-foreground mb-3">Tell Claude something worth remembering:</p>
          <div className="rounded-lg border bg-muted/30 p-4 text-sm space-y-2">
            <p>
              <strong>You:</strong> &quot;Alice is the lead engineer on the Prime project. She
              started in January 2026.&quot;
            </p>
            <p className="text-muted-foreground">
              Claude will call <code>prime_add_node</code> to create a &quot;person&quot; node with
              Alice&apos;s details, then <code>prime_add_edge</code> to connect her to the project.
            </p>
          </div>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-foreground mb-3">4. Recall it later</h2>
          <div className="rounded-lg border bg-muted/30 p-4 text-sm space-y-2">
            <p>
              <strong>You:</strong> &quot;Who works on the Prime project?&quot;
            </p>
            <p className="text-muted-foreground">
            ...
            <p>
              <strong>Claude:</strong> &quot;Alice is the lead engineer on Prime. She started in
              January 2026.&quot;
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="rounded-lg border bg-muted/30 p-4 text-sm space-y-2">
            <p>
              <strong>You:</strong> &quot;What do you know so far?&quot;
            </p>
            <p className="text-muted-foreground">
...
- **Examples:** Alice, Prime`}
        ...
        <section>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
              <a href="/docs/prime/concepts" className="text-foreground underline">
                Concepts
              </a>
              {" — "}understand domains, cross-references, and temporal queries
            </li>
            <li>
              <a href="/docs/prime/mcp" className="text-foreground underline">
                MCP Setup
              </a>
              {" — "}auto-inject, per-project memory, advanced configuration
            </li>
            <li>
              <a href="/docs/prime/http" className="text-foreground underline">
                HTTP API
              </a>
