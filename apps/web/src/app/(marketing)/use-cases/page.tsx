...
const useCases = [
  ...
  },
  {
    ...
    description:
      "Agents that only remember the current conversation are amnesiacs. AllSource gives them a durable memory layer — graph nodes, vector embeddings, and temporal reasoning — accessible via 73 MCP tools.",
    scenario:
    ...
    bullets: [
      "73 MCP tools for Claude, GPT, and custom agents",
