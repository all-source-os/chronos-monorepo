        ...
        <Section className="relative pt-24 pb-16 text-center">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
              Event sourcing for SaaS platforms. Tenant isolation at the storage
              engine level. RBAC with 4 roles and 7 permissions. Policy engine
              for custom authorization. Per-tenant quotas and billing.
            </p>
...
# This event is invisible to every other tenant`}
        ...
        <Section className="pb-24 text-center">
          ...
          <p className="mx-auto mb-8 max-w-xl text-muted-foreground">
            Stop building tenant isolation, RBAC, quotas, and billing from
            scratch. AllSource handles the hard parts so you can focus on your
            product.
          </p>
