        ...
        <Section className="relative pt-24 pb-16 text-center">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
              Query event streams with 11.9us p99 latency. Projections,
              materialized views, and WebSocket streaming for dashboards that
              update in real-time. No ETL pipeline needed.
            </p>
...
# < {"event": {"type": "page_view", "data": {...}, "timestamp": "..."}}`}
        ...
        <Section className="pb-24 text-center">
          ...
          <h2 className="mb-4 text-3xl font-bold">
            Kill your ETL pipeline
          </h2>
          <p className="mx-auto mb-8 max-w-xl text-muted-foreground">
            Stop waiting for batch jobs. Query live event streams with
            sub-microsecond latency and stream updates to dashboards in real-time.
          </p>
