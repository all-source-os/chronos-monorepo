...
**Precondition.** Step 3 produced an `ask_…` key — you (the agent) are holding it.

**Action (agent).** Give the human the `ask_…` key from Step 3 and tell them:
