...
- **Direct render**: a Next.js route that queries Core at request time. The published Core reference benchmark measured 11.9μs p99 projection reads; measure your full request path before choosing this architecture.
