...
- **Option A — Claude Desktop Extension (recommended):** download the `.dxt` bundle, double-click it. Claude Desktop installs it natively and prompts for your API key — paste the one from the page into the dialog and you're done. No terminal, no config editing. macOS (Apple Silicon) and Linux x86_64.
