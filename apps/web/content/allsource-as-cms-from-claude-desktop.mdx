...
Open [www.all-source.xyz/connect](https://www.all-source.xyz/connect) (sign up for the free tier if you don't have an account), click **Create connection**, and pick either path:
