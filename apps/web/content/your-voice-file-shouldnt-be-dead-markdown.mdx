...
(Numbers here trace to the captured demo in [`tooling/voice-demo/RESULTS.md`](https://github.com/all-source-os/all-source/tree/main/tooling/voice-demo); nothing is hand-written.)
...
prime ships as a skill + command inside the [mammoth](https://github.com/all-source-os/all-source/tree/main/plugin/mammoth) plugin — the voice file is the **identity layer** of the same durable memory substrate mammoth gives your agent. Install once:
