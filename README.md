...
|---------|-------|:-------:|:----:|------|
| **Core** | `ghcr.io/all-source-os/chronos-core` | [![v0.8.1](https://img.shields.io/badge/ghcr-v0.8.1-blue?logo=github)](https://github.com/all-source-os/chronos-monorepo/pkgs/container/chronos-core) | **15.7 MB** | Distroless |
